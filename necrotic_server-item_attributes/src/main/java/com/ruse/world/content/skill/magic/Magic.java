package com.ruse.world.content.skill.magic;
...
public class Magic {
	...
	public enum Enchant {
		...
		ZENYTE_NECKLACE(Items.ZENYTE_NECKLACE, Items.NECKLACE_OF_ANGUISH, 87, 97, 721, 452, 6, 1),
		ZENYTE_RING(Items.ZENYTE_RING, Items.RING_OF_SUFFERING, 87, 97, 721, 452, 6, 1),
		ZENYTE_BRACELET(Items.ZENYTE_BRACELET, Items.TORMENTED_BRACELET, 87, 97, 721, 452, 6, 1),
	...
	private enum EnchantSpell {
		...
		EnchantSpell(int spell, int reqRune1, int reqAmtRune1, int reqRune2, int reqAmtRune2, int reqRune3, int reqAmtRune3) {
			this.spell = spell;
