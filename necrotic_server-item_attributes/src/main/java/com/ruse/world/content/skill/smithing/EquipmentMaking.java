...
public class EquipmentMaking {
	...
	public static void smithItem(final Player player, final Item bar, final Item itemToSmith, final int x) {
		...
		for (int i = 0; i < BarData.Bars.values().length; i++) {
			...
			if (bar.getId() == BarData.Bars.values()[i].getItemId()
				&& (itemToSmith.getDefinition().getName().startsWith(ItemDefinition.forId(BarData.Bars.values()[i].getItemId()).getName().substring(0, 3))
		...
		player.setCurrentTask(new Task(3, player, true) {
			...
			public void execute() {
				...
				if (ItemDefinition.forId(itemToSmith.getId()).getName().contains("Bronze")) {
					player.getSkillManager().addExperience(Skill.SMITHING, (int) (BarData.Bars.Bronze.getExp() * bar.getAmount()));
					...
					player.getSkillManager().addExperience(Skill.SMITHING, (int) (BarData.Bars.Iron.getExp() * bar.getAmount()));
					...
					player.getSkillManager().addExperience(Skill.SMITHING, (int) (BarData.Bars.Steel.getExp() * bar.getAmount()));
					...
					player.getSkillManager().addExperience(Skill.SMITHING, (int) (BarData.Bars.Mithril.getExp() * bar.getAmount()));
					...
					player.getSkillManager().addExperience(Skill.SMITHING, (int) (BarData.Bars.Adamant.getExp() * bar.getAmount()));
					...
					player.getSkillManager().addExperience(Skill.SMITHING, (int) (BarData.Bars.Rune.getExp() * bar.getAmount()));
